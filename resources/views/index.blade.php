...
<!-- Mirrored from preview.colorlib.com/theme/jackson/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 02 Apr 2022 16:27:17 GMT -->

<head>
    <script nonce="b915b166-5390-462e-93b6-d10cab8cdf37">
        (function(w, d) {
            ! function(a, e, t, r) {
    ...
    <link rel="stylesheet"
        href="css/A.animate.css%2bicomoon.css%2bbootstrap.css%2bflexslider.css%2cMcc.Sj3he148ay.css.pagespeed.cf.LNIR4uclUB.css" />
    ...
    <link rel="stylesheet"
        href="css/owl.carousel.min.css%2bowl.theme.default.min.css%2bstyle.css.pagespeed.cc.-cwn4TOmp8.css" />
...
<body>
        ...
        <div class="container-wrap">
                ...
                <nav id="colorlib-main-menu" role="navigation" class="navbar">
                    <div id="navbar" class="collapse">
                        <ul>
                            ...
                            <li><a href="#" data-nav-section="blog">Articles</a></li>
            ...
            <div id="colorlib-main">
                                    ...
                                    <div class="row">
                                        <div
                                            ...
                                            <div class="slider-text-inner js-fullheight">
                                                <div class="desc">
                                                    <h2>Hi! <br>I'm Mohammad Sajeed</h2>
                ...
                <section class="colorlib-services" data-section="services">
                    <div class="colorlib-narrow-content">
                        ...
                        <div class="row row-pt-md">
                            @foreach ( $read_experienec as $experienec )
                            <div class="col-md-4 text-center animate-box">
                                <div class="services color-1">
                                    ...
                                    <div class="desc">
                                        <h3> {{$experienec->feild_name}}</h3>
                                        <p>{!! $experienec->description !!}</p>
                                    </div>
                                </div>
                            </div>
                            @endforeach
                ...
                <div id="colorlib-counter" class="colorlib-counters"
                    style="background-image:url(images/xcover_bg_1.jpg.pagespeed.ic.Hi1LCNHI9b.jpg)"
                ...
                <section class="colorlib-skills" data-section="skills">
                    <div class="colorlib-narrow-content">
                        ...
                        <div class="row">
                            ...
                            @foreach ( $read_skills as $skills )
                            <div class="col-md-6 animate-box" data-animate-effect="fadeInLeft">
                                <div class="progress-wrap">
                                    <h3>{{$skills->technology_name}}</h3>
                                    <div class="progress">
                                        <div class="progress-bar color-1" role="progressbar" aria-valuenow="75"
                                            aria-valuemin="0" aria-valuemax="100" style="width:{{$skills->ablity_persentage}}%">
                                            <span>{{$skills->ablity_persentage}}%</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="colorlib-narrow-content">
                        <div class="row">
                            <div class="col-md-6 col-md-offset-3 col-md-pull-3 animate-box"
                                ...
                                <h2 class="colorlib-heading animate-box">Education Information</h2>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 animate-box" data-animate-effect="fadeInLeft">
                                <div class="fancy-collapse-panel">
                                    <div class="panel-group" id="accordion" role="tablist"
                                       ...
                                       @foreach ($read_education as $education )
                                       <div class="panel panel-default">
                                        <div class="panel-heading" role="tab" id="headingTwo">
                                            <h4 class="panel-title">
                                                <a class="collapsed" data-toggle="collapse"
                                                    data-parent="#accordion" href="#collapseTwo"
                                                    aria-expanded="false" aria-controls="collapseTwo">{{$education->degree_name}}
                                                </a>
                                            </h4>
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="timeline-centered">
                                    @foreach ($read_work_experience as $work_experience )
                                    <article class="timeline-entry animate-box" data-animate-effect="fadeInLeft">
                                        <div class="timeline-entry-inner">
                                            ...
                                            <div class="timeline-label">
                                                <h2><a href="#">{{ $work_experience->Job_title }}</a> <span>{{$work_experience->date_details}}</span></h2>
                ...
                <section class="colorlib-work" data-section="work">
                    <div class="colorlib-narrow-content">
                        ...
                        <div class="row row-bottom-padded-sm animate-box" data-animate-effect="fadeInLeft">
                            <div class="col-md-12">
                                {{-- <p class="work-menu"><span><a href="#" class="active">Graphic
                                            Design</a></span> <span><a href="#">Web Design</a></span> <span><a
                                            href="#">Software</a></span> <span><a href="#">Apps</a></span></p> --}}
                            </div>
                        </div>
                        <div class="row">
                            @foreach ($project_work as $project )
                            <div class="col-md-6 animate-box" data-animate-effect="fadeInLeft">
                                <div class="project"
                                    style="background-image:url(images/{{$project->pic}})">
                                    <div class="desc">
                                        <div class="con">
                                            <h3><a href="{{$project->github_link}}">{{$project->project_name}}</a></h3>
                    ...
                    <div class="colorlib-narrow-content">
                        <div class="row">
                            <div class="col-md-6 col-md-offset-3 col-md-pull-3 animate-box"
                                ...
                                <h2 class="colorlib-heading">Recent Articles</h2>
                            </div>
                        </div>
                        <div class="row">
                            @foreach ( $read_artical as $articl )
                            <div class="col-md-4 col-sm-6 animate-box" data-animate-effect="fadeInLeft">
                                <div class="blog-entry">
                                    <a href="blog.html" class="blog-img"><img
                                            src="images/{{$articl->pic}}" class="img-responsive"
                                            alt="HTML5 Bootstrap Template by colorlib.com"></a>
                                    <div class="desc">
                                        <span><small>{{$articl->date}} </small> | <small> {{$articl->category}} </small> | <small> <i
                                                    class="icon-bubble3"></i> 4</small></span>
                                        <h3><a href="blog.html">{{$articl->title}}</a></h3>
    ...
    <script
        src="js/jquery.easing.1.3.js%2bbootstrap.min.js%2bjquery.waypoints.min.js%2bjquery.flexslider-min.js.pagespeed.jc.ypszPGiKrB.js">
    </script>
    <script>
        eval(mod_pagespeed_DMtCOhRI$8);
    </script>

    <script>
        eval(mod_pagespeed_5FoFS8hzQs);
    </script>

    <script>
        eval(mod_pagespeed_zxWiKzenpV);
    </script>

    <script>
        eval(mod_pagespeed_3VV3SdTttZ);
    </script>

    <script src="js/owl.carousel.min.js%2bjquery.countTo.js%2bmain.js.pagespeed.jc.Jy5HeFmhgV.js"></script>
    <script>
        eval(mod_pagespeed_o9wd50kRIS);
    </script>

    <script>
        eval(mod_pagespeed_36JYMA6VkX);
    </script>

    <script>
        eval(mod_pagespeed_d7RBuNVHpz);
    </script>
    ...
    <script defer src="https://static.cloudflareinsights.com/beacon.min.js/v652eace1692a40cfa3763df669d7439c1639079717194"
        ...
        data-cf-beacon='{"rayId":"6f5ae0f47ff3faa8","token":"cd0b4b3a733644fc843ef0b185f98241","version":"2021.12.0","si":100}'
